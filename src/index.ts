...
export {
  ...
  COMPOSITE_DIFFERENCE, COMPOSITE_EXCLUSION, compositeModeNames,
  compositeModeNameToMode
} from './consts'

export { getIndex } from './get-index'
export { isLittleEndian } from './is-little-endian'
export {
  isImageData, isGrayData, isRgbaStop, isRgbaUint32Stop, isChannelStop
} from './predicates'
...
export {
  ...
  CompositeChannel, MapRgba, MapRgbaUint32, MapChannel, AdjustRgba,
  AdjustRgbaUint32, AdjustChannel, RgbaStop, RgbaUint32Stop, ChannelStop
} from './types'
